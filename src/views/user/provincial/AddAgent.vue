<template>
  <div class="dashboard-container">
    <div class="dashboard-management">
      <div class="dashboard-text">新增省级代理商</div>
    </div>
    <div class="user">
        ...
        <div class="basic-information">
          <ul class="basic-information-project">
            ...
            <li>
              ...
              <v-distpicker :dprovince="region.dprovince" only-province @selected="getRegion" />
            </li>
            <li>
              <p>负责人</p>
    ...
    <el-dialog title="提示" :visible.sync="basicT" width="30%">
      <span style="font-size:20px;">是否确定新增?</span>
...
<script>
import { getAddAgent, getProvincialAgentAdd } from '@/api/user.js'
...
export default {
    ...
    methods: {
        ...
        getRegion(data) {
            ...
            // console.log(this.region.dprovince)
        },
        ...
        saveData() {
            ...
            this.basicT = false
            this.$router.push('/user/provincial')
        }
    }
}
</script>
