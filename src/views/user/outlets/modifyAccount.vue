<template>
  <div class="dashboard-container">
    <div class="dashboard-management">
      <div class="dashboard-text">修改网点管理员</div>
    </div>
    <div class="user">
      ...
      <div class="save" @click="modifyOutletsAccountDetails">确认修改</div>
    </div>
  </div>
</template>

<script>
import { modifyOutletsAccountDetails, getOutletsAccountDetails } from '@/api/user.js'
export default {
    data() {
        return {
            id: '',
    ...
    methods: {
        // 修改 账号
        modifyOutletsAccountDetails(id) {
